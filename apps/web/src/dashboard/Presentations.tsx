/**
 * Presentations - PowerPoint-like presentation builder
 *
 * For pitch decks, agent training materials, and client presentations
 */
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-sm font-mono text-white/60">
              Pitch decks, training slides, and presentations
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-sm font-mono text-white/40 mb-6">
            Create your first presentation or browse templates
          </p>
          <div className="flex items-center gap-2">
            <button
        ...
        <div className="mt-8 p-6 bg-surface-1 border border-white/10 rounded-none">
          ...
          <p className="text-xs font-mono text-white/60 leading-relaxed">
            PowerPoint-like slide editor with drag-drop elements, animations, and presenter notes.
            Perfect for pitch decks and agent training materials.
          </p>
        </div>
      </div>
    </div>
